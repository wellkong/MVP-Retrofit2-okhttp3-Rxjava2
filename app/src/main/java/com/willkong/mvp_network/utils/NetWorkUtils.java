...
import com.willkong.mvp_network.app.App;
...
public class NetWorkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) App.instance()
...
//        isAvailableByPing successMsg
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) App.instance().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
